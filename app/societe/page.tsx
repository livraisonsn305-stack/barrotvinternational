  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        <h1 className="text-4xl font-black text-[#111b35]">Société</h1>
        <div className="mt-6 rounded-2xl border p-5 shadow-sm">
          <div className="text-xs font-black uppercase tracking-wider text-[#d62828]">Actualité Sénégal</div>
          <h2 className="mt-2 text-2xl font-bold">Les informations importantes de la société sénégalaise</h2>
        </div>
      </section>
    </main>
  );
